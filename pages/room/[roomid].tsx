        ...
        <div className="h-screen bg-gray-900 px-4 pb-16">
            ...
            <main className="flex h-full flex-col items-center justify-between pt-6">
                ...
                <div className="mt-4 flex w-full justify-center">
                    <Link href="shape">
                        <a className="mx-auto flex w-1/3 items-center justify-center rounded-lg border-2 border-gray-100 py-3 text-xl text-gray-100">
                            Random
                        </a>
                    </Link>
                    <Link href="shape">
                        <a className="mx-auto flex w-1/3 items-center justify-center rounded-lg border-2 border-gray-100 bg-white py-3 text-xl">
                            Go
                        </a>
                    </Link>
                </div>
